mod test {
    ...
    // leaving off a few tests here because they are tedious to type
    #[test]
    fn list() {
        expect_type("isnil (cons 1 (cons 2 (cons 3 nil)))", Type::Bool);
        expect_type("hd (cons 1 (cons 2 (cons 3 nil)))", Type::Nat);
    }
