...
//        let mut m = HashMap::new();
//        m.insert("tru", TokenType::Tru);
//        m.insert("fls", TokenType::Fls);
//        m
//    };
//}
//
...
//            match keyword_tt {
//                TokenType::Fls => {
//                    self.add_term_token(TokenType::Fls, ZERO.clone());
//                }
//                TokenType::Tru => {
//                    self.add_term_token(TokenType::Tru, TRU.clone());
//                }
